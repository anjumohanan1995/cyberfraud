...
<div class="container-fluid">
    <div class="breadcrumb-header justify-content-between">
        <div>
            <h4 class="content-title mb-2">Merchant !</h4>
                ...
                <div class="card overflow-hidden review-project">
                    <div class="card-body">
                        ...
                        <div class="table-responsive mb-0">
                            <form id="sourceTypeForm" action="{{ route('merchant.store') }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">Name:</label>
                                            <input type="text" id="name" name="name" class="form-control" placeholder="Enter Merchant" value="{{ old('name') }}" required>
