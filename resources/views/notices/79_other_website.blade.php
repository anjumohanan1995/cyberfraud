<body style="font-family: Arial, sans-serif; margin: 0; padding: 20px; background-color: #f4f4f4;">
    <div style="background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); margin-bottom: 20px;">
        ...
        <p style="margin: 0; padding: 0; font-size: 16px; line-height: 1.5;">
            We are writing to bring your immediate attention to a matter of grave concern regarding the website mentioned below, which is involved in financial fraud.
            <br><br>
            As stipulated by Section 79(3)(b) of the Information Technology Act of India, you are hereby directed to take down the below-mentioned website within 24 hours and preserve the details for further investigation.
            <br><br>
            As an intermediary, if you fail to remove or disable the unlawful content immediately, the protection under Section 79 of the IT Act will not be applicable, and you will be liable for abetment.
        </p>
        <br>
