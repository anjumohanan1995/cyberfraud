<body style="font-family: Arial, sans-serif; margin: 0; padding: 20px; background-color: #f4f4f4;">
    <div style="background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); margin-bottom: 20px;">
        ...
        <p style="margin: 0; padding: 0; font-size: 16px; line-height: 1.5;">
            ...
            <br><br>
            As stipulated by Section 79(3)(b) of the Information Technology Act of India, you are hereby directed to <b>REMOVE/DISABLE</b> and <b>PRESERVE</b> the aforesaid content posted on your social media platform and, as per Section 94 of Bharatiya Nagarik Suraksha Sanhita<b>(BNSS)</b>, also directed to <b>PROVIDE</b> the details associated with the alleged URLs to this office at the earliest.
            <br><br>
